<template>
    <div :class="containerClass">
        <div class="flex items-center justify-center" :class="contentClass">
            <div class="relative">
                <!-- Spinner -->
                <div class="animate-spin rounded-full border-2 border-gray-300" :class="spinnerClass" :style="{ borderTopColor: color }"></div>

                <!-- Optional inner dot -->
                <div
                    v-if="showDot"
                    class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transform rounded-full"
                    :class="dotClass"
