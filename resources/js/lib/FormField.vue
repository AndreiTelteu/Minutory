<template>
    <div class="form-field">
        ...
        <div class="relative">
            ...
            <!-- Success indicator -->
            <div v-else-if="showSuccess && !hasError && modelValue" class="absolute inset-y-0 right-0 flex items-center pr-3">
        ...
        <p
            ...
            :class="['mt-1 text-right text-xs', characterCount > maxLength ? 'text-red-600' : 'text-gray-500']"
        >
