        ...
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600">Manage your clients and organize meetings by client accounts.</p>
                </div>
                <div>
                    <Link
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase">Company</th>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase">Meetings</th>
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            <tr v-for="client in clients" :key="client.id" class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <Link :href="route('clients.show', client.id)" class="font-medium text-blue-600 hover:text-blue-800">
                                        {{ client.name }}
                                    </Link>
                                </td>
                                ...
                                <td class="px-6 py-4 text-right text-sm font-medium whitespace-nowrap">
                                    <Link :href="route('clients.edit', client.id)" class="mr-4 text-blue-600 hover:text-blue-900"> Edit </Link>
                                    <button
                                        @click="deleteClient(client)"
                                        class="text-red-600 hover:text-red-900"
                                        :disabled="(client.meetings_count ?? 0) > 0"
                                        :class="{ 'cursor-not-allowed opacity-50': (client.meetings_count ?? 0) > 0 }"
                                    >
                                        Delete
                                    </button>
                                </td>
